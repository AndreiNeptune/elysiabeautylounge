import{a as e,i as t,n,o as r,r as i,s as a,t as o}from"./load-more-C9QaN6uY.js";function s(){let e=document.getElementById(`shared-nav`);e&&(e.outerHTML=c());let t=document.getElementById(`shared-drawer`);t&&(t.outerHTML=l());let n=document.getElementById(`shared-footer`);n&&(n.outerHTML=u())}function c(){return`
  ...
  </footer>`}document.addEventListener(`DOMContentLoaded`,()=>{s(),document.querySelectorAll(`[data-year]`).forEach(e=>{e.textContent=new Date().getFullYear()}),a(),r(),e(),i(),t(),n(),o()});